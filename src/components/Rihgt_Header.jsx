...
const Rihgt_Header = () => {
  ...
  return (
    <div className="header-right flex gap-10">
        <a href="https://wa.me/+6003639598?text=https://www.electronicjunction.com/%0a%0aHi! I need some help." className="w-6 h-6 search-icon hover:w-6.5 h-6.5 hover:transform hover:scale-110 transition-transform duration-200 ease-in"><img src={watsapp} alt="whatsapp" /></a>
        {
          User?._id ? (
